...
export const loadLanguageMap = isNode
  ? loadLanguageMapNode
  : loadLanguageMapBrowser;
export const convertLanguageFormat = isNode
  ? convertLanguageFormatNode
  : convertLanguageFormatBrowser;
